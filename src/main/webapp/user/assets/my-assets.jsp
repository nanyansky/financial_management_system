    ...
    <div class="layuimini-main">
        ...
        <div style="display: none;padding: 5px" id="addOrUpdateWindow">
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                ...
                <div class="layui-form-item">
                    <input type="hidden" name="assetsOwnerId" value="${sessionScope.user.id}">
                    <label class="layui-form-label">资产拥有人</label>
                    <div class="layui-input-block">
                        <input type="text" name="assetsOwnerName" class="layui-input" value="${sessionScope.user.userName}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.use(['form', 'table', 'layer','laydate'], function () {
        ...
        var tableIns = table.render({
            elem: '#currentTableId',
            url: '/user/getUserAssetsListByPage.action',
            toolbar: '#toolbarDemo',
