    ...
    <div class="layuimini-main">
        ...
        <div style="display: none;padding: 5px" id="addOrUpdateWindow">
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                ...
                <div class="layui-form-item">
                    <input type="hidden" name="debtOwnerId" value="${sessionScope.user.id}">
                    <label class="layui-form-label">债务拥有人</label>
                    <div class="layui-input-block">
                        <input type="text" name="debtOwnerName" class="layui-input" value="${sessionScope.user.userName}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.use(['form', 'table', 'layer','laydate'], function () {
        ...
        var tableIns = table.render({
            elem: '#currentTableId',
            url: '/user/getUserDebtListByPage.action',
            toolbar: '#toolbarDemo',
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            if(data.field.debtType === "-1"){
                ...
                tableIns.reload({
                    url: '/user/searchUserDebtList.action',
                    method: "post",
                    page: {
                        curr: 1
                    }
