...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(statics/layui/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(statics/layui/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(statics/layui/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(statics/layui/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(statics/layui/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(statics/layui/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url(statics/layui/images/icon-login.png) no-repeat -111px -48px;}
        ...
        body {background:url(statics/layui/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div class="item" style="height: 24px">
                    ...
                    <input type="password" name="password" id="pwd1" lay-verify="required|passwordLength"  placeholder="请输入密码" maxlength="20">
                    <span class="bind-password icon icon-4"></span>
                </div>

                <div class="item" style="height: 24px">
                    <span class="icon icon-3"></span>
                    <input type="password" name="password" id="pwd2" onblur="confirmPwd()" lay-verify="required|passwordLength"  placeholder="请确认密码" maxlength="20">
