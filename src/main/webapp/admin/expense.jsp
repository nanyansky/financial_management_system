...
<%--                               placeholder="请输入用户名" class="layui-input">--%>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="expenseTypeId" lay-verify="" id="fenlei">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="expenseAmount" lay-verify="required" lay-reqtext="金额为空" placeholder="请输入收入金额" value="" class="layui-input">
                    </div>
                </div>
    ...
    layui.use(['form', 'table', 'layer'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                ,{field: 'expenseTime',title: "添加时间",minWidth: 120, align: 'center'}
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            //执行搜索重载
            tableIns.reload({
                url: '/expense/getExpenseListByUserName.action',
                method: "post",
                page: {
                    curr: 1
                }
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $.each(result.data,function (index,value) {
                    ...
                    $('#fenlei').append(new Option(value.name,value.id));
                });
