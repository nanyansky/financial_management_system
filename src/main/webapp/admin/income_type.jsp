                ...
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">收入分类名</label>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="name" lay-verify="required" autocomplete="off"
                               placeholder="请输入收入分类名" class="layui-input">
                    </div>
                </div>
...
<script>
    layui.use(['form', 'table', 'layer'], function () {
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            //执行搜索重载
            tableIns.reload({
                url: '/getIncomeTypeListByName.action',
                method: "post",
                page: {
                    curr: 1
                }
        ...
        function deleteById(data){
            layer.confirm("确定要删除该条记录吗？",{icon: 3,title: '提示'},function (index) {
                //发送ajax请求删除
                $.get("/deleteIncomeByTypeById.action",{"id":data.id},function (result){
                    if (result.code === 1){
