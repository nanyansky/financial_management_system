...
<%--                               placeholder="请输入用户名" class="layui-input">--%>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="incomeSource" required lay-verify="required" placeholder="请输入收入来源" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    layui.use(['form', 'table', 'layer'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                ,{field: 'incomeTime',title: "添加时间",minWidth: 120, align: 'center'}
                ,{field: 'incomeAmount',title: "收入金额",minWidth: 120, align: 'center'}
                ,{field: 'incomeSource',title: "收入来源",minWidth: 120, align: 'center'}
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            //执行搜索重载
            tableIns.reload({
                url: '/income/getIncomeListByUserName.action',
                method: "post",
                page: {
                    curr: 1
                }
